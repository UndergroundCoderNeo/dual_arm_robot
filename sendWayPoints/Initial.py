...
def main():
	init_socket()	
	cmd="<start>LP/ movej_pose([-900,700,1250,90,0,167],40,20,-1);movej([-0,-0,-0,-90,0,-0,0],30,2000,-1); /RP/ movej_pose([900,700,1250,90,0,167],40,20,-1);movej([0,-0,0,90,-0,-0,0],30,2000,-1);<end>"
