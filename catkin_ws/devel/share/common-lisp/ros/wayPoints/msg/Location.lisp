...
(cl:defmethod cl:initialize-instance :after ((m <Location>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Location)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wayPoints-msg:<Location> is deprecated: use wayPoints-msg:Location instead.")))
...
(cl:defmethod x-val ((m <Location>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wayPoints-msg:x-val is deprecated.  Use wayPoints-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Location>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wayPoints-msg:y-val is deprecated.  Use wayPoints-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Location>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wayPoints-msg:z-val is deprecated.  Use wayPoints-msg:z instead.")
  (z m))
