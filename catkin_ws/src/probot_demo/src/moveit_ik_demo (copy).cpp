...
int getCup(moveit::planning_interface::MoveGroupInterface arm)
{
  // 设置机器人终端的目标位置
...
int raiseCup(moveit::planning_interface::MoveGroupInterface arm)
{
    // 设置机器人终端的目标位置
    geometry_msgs::Pose target_pose;
    target_pose.orientation.x = 0;
...
int rotateCup(moveit::planning_interface::MoveGroupInterface arm)
{
        // 设置机器人终端的目标位置
    geometry_msgs::Pose target_pose;
    target_pose.orientation.x = 0;
